...
import de.chaosolymp.votemanager.bungee.dispatcher.VoteDispatcher
import de.chaosolymp.votemanager.bungee.listener.PlayerListener
import de.chaosolymp.votemanager.bungee.listener.PluginCommunicationListener
...
class BungeePlugin : Plugin() {
    ...
    lateinit var uuidResolver: UUIDResolver
    ...
    override fun onEnable() {
        ...
        this.voteDispatcher =
            VoteDispatcher(this)
        this.uuidResolver = UUIDResolver(this)
        ...
        this.proxy.pluginManager.registerListener(this, PluginCommunicationListener(this))
